...
const Post = ({recipe}: Props) => {
    ...
    const recipeSingle = recipe.results[0];
    /*if (!router.isFallback && !recipe?.id) { //&& !recipe?.slug
        return <ErrorPage statusCode={404} />;
    }*/
    console.log('Component');
    console.log(recipe.results[0]);
    return (
        <div className={stylesHp.container}>
            <Head>
                <title>{recipeSingle.Title}</title>
            ...
            <main className={stylesHp.main}>
                <div>
                    ...
                    <div className={stylesHp.HeroImage}>
                        <img  src={recipeSingle.ImageList.results[0].fileUrl}/>
                    </div>
                </div>
                <div className={stylesHp.boxedContainer} >
                    <h1>{recipeSingle.Title}</h1>
                    <p>
                        <strong>Duration:</strong> {recipeSingle.Duration} min.<br/>
                        <strong>Ingredients:</strong> {recipeSingle.Ingredients}
                    </p>
                    <p>
                    {recipeSingle.Description}
                    </p>
